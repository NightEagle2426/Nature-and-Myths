...
import net.mcreator.natureandmyths.item.AquamarineGemItem;
...
public class AquamarineOreBlock extends NatureandmythsModElements.ModElement {
	@ObjectHolder("natureandmyths:aquamarineore")
	public static final Block block = null;
	public AquamarineOreBlock(NatureandmythsModElements instance) {
		super(instance, 62);
	}
	...
	public void init(FMLCommonSetupEvent event) {
		for (Biome biome : ForgeRegistries.BIOMES.getValues()) {
			...
			}.withConfiguration(new OreFeatureConfig(OreFeatureConfig.FillerBlockType.create("aquamarineore", "aquamarineore", blockAt -> {
				boolean blockCriteria = false;
				if (blockAt.getBlock() == Blocks.STONE.getDefaultState().getBlock())
					blockCriteria = true;
				return blockCriteria;
			}), block.getDefaultState(), 6)).withPlacement(Placement.COUNT_RANGE.configure(new CountRangeConfig(2, 1, 1, 23))));
		}
	}
}
