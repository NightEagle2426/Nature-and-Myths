...
public class PlutoniumOreBlock extends NatureandmythsModElements.ModElement {
	@ObjectHolder("natureandmyths:plutonium_ore")
	public static final Block block = null;
	public PlutoniumOreBlock(NatureandmythsModElements instance) {
		super(instance, 167);
	}
	...
	public void init(FMLCommonSetupEvent event) {
		for (Biome biome : ForgeRegistries.BIOMES.getValues()) {
			...
			}.withConfiguration(new OreFeatureConfig(OreFeatureConfig.FillerBlockType.create("plutonium_ore", "plutonium_ore", blockAt -> {
				boolean blockCriteria = false;
				if (blockAt.getBlock() == Blocks.STONE.getDefaultState().getBlock())
					blockCriteria = true;
				return blockCriteria;
			}), block.getDefaultState(), 1)).withPlacement(Placement.COUNT_RANGE.configure(new CountRangeConfig(1, 3, 3, 9))));
		}
	}
}
