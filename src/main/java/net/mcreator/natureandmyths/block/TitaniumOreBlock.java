...
public class TitaniumOreBlock extends NatureandmythsModElements.ModElement {
	@ObjectHolder("natureandmyths:titaniumore")
	public static final Block block = null;
	public TitaniumOreBlock(NatureandmythsModElements instance) {
		super(instance, 114);
	}
