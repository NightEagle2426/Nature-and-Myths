...
public class AquamarineOreBlockBlock extends NatureandmythsModElements.ModElement {
	@ObjectHolder("natureandmyths:aquamarineoreblock")
	public static final Block block = null;
	public AquamarineOreBlockBlock(NatureandmythsModElements instance) {
		super(instance, 116);
	}
