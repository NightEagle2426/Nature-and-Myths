...
public class LithiumOreBlockBlock extends NatureandmythsModElements.ModElement {
	@ObjectHolder("natureandmyths:lithiumoreblock")
	public static final Block block = null;
	public LithiumOreBlockBlock(NatureandmythsModElements instance) {
		super(instance, 148);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("lithiumoreblock");
		}
