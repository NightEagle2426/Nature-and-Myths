...
public class AmatistOreBlockBlock extends NatureandmythsModElements.ModElement {
	@ObjectHolder("natureandmyths:amatistoreblock")
	public static final Block block = null;
	public AmatistOreBlockBlock(NatureandmythsModElements instance) {
		super(instance, 130);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("amatistoreblock");
		}
