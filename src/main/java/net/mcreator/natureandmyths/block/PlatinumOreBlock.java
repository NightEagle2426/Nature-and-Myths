...
public class PlatinumOreBlock extends NatureandmythsModElements.ModElement {
	@ObjectHolder("natureandmyths:platinumore")
	public static final Block block = null;
	public PlatinumOreBlock(NatureandmythsModElements instance) {
		super(instance, 66);
	}
	...
	public void init(FMLCommonSetupEvent event) {
		for (Biome biome : ForgeRegistries.BIOMES.getValues()) {
			...
			}.withConfiguration(new OreFeatureConfig(OreFeatureConfig.FillerBlockType.create("platinumore", "platinumore", blockAt -> {
