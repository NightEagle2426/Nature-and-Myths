...
public class SodaliteOreBlockBlock extends NatureandmythsModElements.ModElement {
	@ObjectHolder("natureandmyths:sodaliteoreblock")
	public static final Block block = null;
	public SodaliteOreBlockBlock(NatureandmythsModElements instance) {
		super(instance, 152);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("sodaliteoreblock");
		}
