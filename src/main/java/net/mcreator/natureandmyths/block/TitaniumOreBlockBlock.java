...
public class TitaniumOreBlockBlock extends NatureandmythsModElements.ModElement {
	@ObjectHolder("natureandmyths:titaniumoreblock")
	public static final Block block = null;
	public TitaniumOreBlockBlock(NatureandmythsModElements instance) {
		super(instance, 115);
	}
