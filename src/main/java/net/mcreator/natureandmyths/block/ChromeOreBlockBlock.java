...
public class ChromeOreBlockBlock extends NatureandmythsModElements.ModElement {
	@ObjectHolder("natureandmyths:chromeoreblock")
	public static final Block block = null;
	public ChromeOreBlockBlock(NatureandmythsModElements instance) {
		super(instance, 135);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("chromeoreblock");
		}
