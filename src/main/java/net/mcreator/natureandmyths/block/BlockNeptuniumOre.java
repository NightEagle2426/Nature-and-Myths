...
public class BlockNeptuniumOre extends ElementsNatureandMyths.ModElement {
	@GameRegistry.ObjectHolder("natureandmyths:neptuniumore")
	public static final Block block = null;
	public BlockNeptuniumOre(ElementsNatureandMyths instance) {
		super(instance, 535);
	}

	@Override
	public void initElements() {
		elements.blocks.add(() -> new BlockCustom().setRegistryName("neptuniumore"));
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0,
				new ModelResourceLocation("natureandmyths:neptuniumore", "inventory"));
	}
	...
	public static class BlockCustom extends Block {
		public BlockCustom() {
			super(Material.ROCK);
			setUnlocalizedName("neptuniumore");
