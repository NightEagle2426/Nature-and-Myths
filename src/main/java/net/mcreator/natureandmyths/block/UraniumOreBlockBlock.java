...
public class UraniumOreBlockBlock extends NatureandmythsModElements.ModElement {
	@ObjectHolder("natureandmyths:uraniumoreblock")
	public static final Block block = null;
	public UraniumOreBlockBlock(NatureandmythsModElements instance) {
		super(instance, 146);
	}
