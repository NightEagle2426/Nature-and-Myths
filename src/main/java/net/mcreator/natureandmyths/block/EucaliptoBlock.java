...
public class EucaliptoBlock extends NatureandmythsModElements.ModElement {
	@ObjectHolder("natureandmyths:eucalipto")
	public static final Block block = null;
	public EucaliptoBlock(NatureandmythsModElements instance) {
		super(instance, 70);
	}
