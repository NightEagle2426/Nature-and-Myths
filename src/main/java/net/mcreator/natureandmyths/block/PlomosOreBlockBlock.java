...
public class PlomosOreBlockBlock extends NatureandmythsModElements.ModElement {
	@ObjectHolder("natureandmyths:plomosoreblock")
	public static final Block block = null;
	public PlomosOreBlockBlock(NatureandmythsModElements instance) {
		super(instance, 124);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("plomosoreblock");
		}
