...
public class MarmolPWBlock extends NatureandmythsModElements.ModElement {
	@ObjectHolder("natureandmyths:marmolpw")
	public static final Block block = null;
	public MarmolPWBlock(NatureandmythsModElements instance) {
		super(instance, 91);
	}
	...
	public static class CustomBlock extends WallBlock {
		public CustomBlock() {
			super(Block.Properties.create(Material.ROCK).sound(SoundType.STONE).hardnessAndResistance(15f, 10f).lightValue(0).notSolid());
			setRegistryName("marmolpw");
		}
