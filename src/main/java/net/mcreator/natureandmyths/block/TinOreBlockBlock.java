...
public class TinOreBlockBlock extends NatureandmythsModElements.ModElement {
	@ObjectHolder("natureandmyths:tinoreblock")
	public static final Block block = null;
	public TinOreBlockBlock(NatureandmythsModElements instance) {
		super(instance, 65);
	}
