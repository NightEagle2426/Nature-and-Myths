...
public class ManganesiumOreBlockBlock extends NatureandmythsModElements.ModElement {
	@ObjectHolder("natureandmyths:manganesiumoreblock")
	public static final Block block = null;
	public ManganesiumOreBlockBlock(NatureandmythsModElements instance) {
		super(instance, 125);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("manganesiumoreblock");
		}
