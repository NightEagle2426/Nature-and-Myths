...
public class TungstenOreBlockBlock extends NatureandmythsModElements.ModElement {
	@ObjectHolder("natureandmyths:tungstenoreblock")
	public static final Block block = null;
	public TungstenOreBlockBlock(NatureandmythsModElements instance) {
		super(instance, 117);
	}
