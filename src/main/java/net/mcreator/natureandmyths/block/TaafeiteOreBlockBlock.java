...
public class TaafeiteOreBlockBlock extends NatureandmythsModElements.ModElement {
	@ObjectHolder("natureandmyths:taafeite_ore_block")
	public static final Block block = null;
	public TaafeiteOreBlockBlock(NatureandmythsModElements instance) {
		super(instance, 163);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("taafeite_ore_block");
		}
