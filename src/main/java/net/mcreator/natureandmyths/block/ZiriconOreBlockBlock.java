...
public class ZiriconOreBlockBlock extends NatureandmythsModElements.ModElement {
	@ObjectHolder("natureandmyths:ziriconoreblock")
	public static final Block block = null;
	public ZiriconOreBlockBlock(NatureandmythsModElements instance) {
		super(instance, 150);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("ziriconoreblock");
		}
