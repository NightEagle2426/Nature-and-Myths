...
public class Nikel1OreBlockBlock extends NatureandmythsModElements.ModElement {
	@ObjectHolder("natureandmyths:nikel1oreblock")
	public static final Block block = null;
	public Nikel1OreBlockBlock(NatureandmythsModElements instance) {
		super(instance, 129);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("nikel1oreblock");
		}
