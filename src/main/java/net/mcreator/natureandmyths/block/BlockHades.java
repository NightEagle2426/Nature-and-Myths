...
public class BlockHades extends ElementsNatureandMyths.ModElement {
	@GameRegistry.ObjectHolder("natureandmyths:hades")
	public static final Block block = null;
	public BlockHades(ElementsNatureandMyths instance) {
		super(instance, 30);
	}

	@Override
	public void initElements() {
		elements.blocks.add(() -> new BlockCustom().setRegistryName("hades"));
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0, new ModelResourceLocation("natureandmyths:hades", "inventory"));
	}
