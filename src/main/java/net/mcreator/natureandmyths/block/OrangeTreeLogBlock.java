...
public class OrangeTreeLogBlock extends NatureandmythsModElements.ModElement {
	@ObjectHolder("natureandmyths:orangetreelog")
	public static final Block block = null;
	public OrangeTreeLogBlock(NatureandmythsModElements instance) {
		super(instance, 137);
	}
