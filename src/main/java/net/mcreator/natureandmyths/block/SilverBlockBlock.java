...
public class SilverBlockBlock extends NatureandmythsModElements.ModElement {
	@ObjectHolder("natureandmyths:silverblock")
	public static final Block block = null;
	public SilverBlockBlock(NatureandmythsModElements instance) {
		super(instance, 77);
	}
