...
public class JadeOreBlockBlock extends NatureandmythsModElements.ModElement {
	@ObjectHolder("natureandmyths:jadeoreblock")
	public static final Block block = null;
	public JadeOreBlockBlock(NatureandmythsModElements instance) {
		super(instance, 154);
	}
