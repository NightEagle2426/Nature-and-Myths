...
public class MusgraviteOreBlockBlock extends NatureandmythsModElements.ModElement {
	@ObjectHolder("natureandmyths:musgravite_ore_block")
	public static final Block block = null;
	public MusgraviteOreBlockBlock(NatureandmythsModElements instance) {
		super(instance, 159);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("musgravite_ore_block");
		}
