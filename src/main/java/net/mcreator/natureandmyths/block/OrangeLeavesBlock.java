...
public class OrangeLeavesBlock extends NatureandmythsModElements.ModElement {
	@ObjectHolder("natureandmyths:orangeleaves")
	public static final Block block = null;
	public OrangeLeavesBlock(NatureandmythsModElements instance) {
		super(instance, 138);
	}
