...
public class ScandiumOreBlockBlock extends NatureandmythsModElements.ModElement {
	@ObjectHolder("natureandmyths:scandiumoreblock")
	public static final Block block = null;
	public ScandiumOreBlockBlock(NatureandmythsModElements instance) {
		super(instance, 127);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("scandiumoreblock");
		}
