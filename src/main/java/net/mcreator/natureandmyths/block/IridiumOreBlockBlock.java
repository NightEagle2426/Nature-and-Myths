...
public class IridiumOreBlockBlock extends NatureandmythsModElements.ModElement {
	@ObjectHolder("natureandmyths:iridiumoreblock")
	public static final Block block = null;
	public IridiumOreBlockBlock(NatureandmythsModElements instance) {
		super(instance, 142);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("iridiumoreblock");
		}
