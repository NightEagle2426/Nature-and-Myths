...
public class OrichalcumOreBlockBlock extends NatureandmythsModElements.ModElement {
	@ObjectHolder("natureandmyths:orichalcumoreblock")
	public static final Block block = null;
	public OrichalcumOreBlockBlock(NatureandmythsModElements instance) {
		super(instance, 133);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("orichalcumoreblock");
		}
