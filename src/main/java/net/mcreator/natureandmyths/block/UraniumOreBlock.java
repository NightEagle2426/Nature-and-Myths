...
public class UraniumOreBlock extends NatureandmythsModElements.ModElement {
	@ObjectHolder("natureandmyths:uraniumore")
	public static final Block block = null;
	public UraniumOreBlock(NatureandmythsModElements instance) {
		super(instance, 145);
	}
	...
	public void init(FMLCommonSetupEvent event) {
		for (Biome biome : ForgeRegistries.BIOMES.getValues()) {
			...
			}.withConfiguration(new OreFeatureConfig(OreFeatureConfig.FillerBlockType.create("uraniumore", "uraniumore", blockAt -> {
				boolean blockCriteria = false;
				if (blockAt.getBlock() == Blocks.STONE.getDefaultState().getBlock())
					blockCriteria = true;
				return blockCriteria;
			}), block.getDefaultState(), 1)).withPlacement(Placement.COUNT_RANGE.configure(new CountRangeConfig(2, 6, 6, 7))));
		}
	}
}
