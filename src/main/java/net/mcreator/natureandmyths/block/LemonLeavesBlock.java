...
public class LemonLeavesBlock extends NatureandmythsModElements.ModElement {
	@ObjectHolder("natureandmyths:lemonleaves")
	public static final Block block = null;
	public LemonLeavesBlock(NatureandmythsModElements instance) {
		super(instance, 139);
	}
