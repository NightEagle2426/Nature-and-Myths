...
public class TopazOreBlockBlock extends NatureandmythsModElements.ModElement {
	@ObjectHolder("natureandmyths:topazoreblock")
	public static final Block block = null;
	public TopazOreBlockBlock(NatureandmythsModElements instance) {
		super(instance, 121);
	}
