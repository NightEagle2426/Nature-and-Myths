...
public class CasariteOreBlockBlock extends NatureandmythsModElements.ModElement {
	@ObjectHolder("natureandmyths:casariteoreblock")
	public static final Block block = null;
	public CasariteOreBlockBlock(NatureandmythsModElements instance) {
		super(instance, 144);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("casariteoreblock");
		}
