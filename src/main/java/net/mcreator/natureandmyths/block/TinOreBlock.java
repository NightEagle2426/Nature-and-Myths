...
public class TinOreBlock extends NatureandmythsModElements.ModElement {
	@ObjectHolder("natureandmyths:tinore")
	public static final Block block = null;
	public TinOreBlock(NatureandmythsModElements instance) {
		super(instance, 122);
	}
