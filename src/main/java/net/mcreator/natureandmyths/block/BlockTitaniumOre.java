...
public class BlockTitaniumOre extends ElementsNatureandMyths.ModElement {
	@GameRegistry.ObjectHolder("natureandmyths:titaniumore")
	public static final Block block = null;
	public BlockTitaniumOre(ElementsNatureandMyths instance) {
		super(instance, 7);
	}
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0,
				new ModelResourceLocation("natureandmyths:titaniumore", "inventory"));
	}
