...
public class EucaliptusSapplingBlock extends NatureandmythsModElements.ModElement {
	@ObjectHolder("natureandmyths:eucaliptussappling")
	public static final Block block = null;
	public EucaliptusSapplingBlock(NatureandmythsModElements instance) {
		super(instance, 136);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			super(Block.Properties.create(Material.PLANTS).sound(SoundType.PLANT).hardnessAndResistance(1f, 10f).lightValue(0).doesNotBlockMovement()
					.notSolid());
			setRegistryName("eucaliptussappling");
		}
