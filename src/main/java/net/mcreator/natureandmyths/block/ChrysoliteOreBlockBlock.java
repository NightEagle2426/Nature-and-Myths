...
public class ChrysoliteOreBlockBlock extends NatureandmythsModElements.ModElement {
	@ObjectHolder("natureandmyths:chrysoliteoreblock")
	public static final Block block = null;
	public ChrysoliteOreBlockBlock(NatureandmythsModElements instance) {
		super(instance, 126);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("chrysoliteoreblock");
		}
