...
public class BlockRubyore extends ElementsNatureandMyths.ModElement {
	@GameRegistry.ObjectHolder("natureandmyths:rubyore")
	public static final Block block = null;
	public BlockRubyore(ElementsNatureandMyths instance) {
		super(instance, 28);
	}
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0, new ModelResourceLocation("natureandmyths:rubyore", "inventory"));
	}
