...
public class TroncoManzanoBlock extends NatureandmythsModElements.ModElement {
	@ObjectHolder("natureandmyths:troncomanzano")
	public static final Block block = null;
	public TroncoManzanoBlock(NatureandmythsModElements instance) {
		super(instance, 68);
	}
