...
public class RodiumOreBlockBlock extends NatureandmythsModElements.ModElement {
	@ObjectHolder("natureandmyths:rodiumoreblock")
	public static final Block block = null;
	public RodiumOreBlockBlock(NatureandmythsModElements instance) {
		super(instance, 119);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("rodiumoreblock");
		}
