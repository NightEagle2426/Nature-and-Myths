...
public class HafniumOreBlockBlock extends NatureandmythsModElements.ModElement {
	@ObjectHolder("natureandmyths:hafnium_ore_block")
	public static final Block block = null;
	public HafniumOreBlockBlock(NatureandmythsModElements instance) {
		super(instance, 166);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("hafnium_ore_block");
		}
