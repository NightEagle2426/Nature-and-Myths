...
public class BlockMarmol extends ElementsNatureandMyths.ModElement {
	@GameRegistry.ObjectHolder("natureandmyths:marmol")
	public static final Block block = null;
	public BlockMarmol(ElementsNatureandMyths instance) {
		super(instance, 43);
	}

	@Override
	public void initElements() {
		elements.blocks.add(() -> new BlockCustom().setRegistryName("marmol"));
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0, new ModelResourceLocation("natureandmyths:marmol", "inventory"));
	}
