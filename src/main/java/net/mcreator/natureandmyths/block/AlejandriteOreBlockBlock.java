...
public class AlejandriteOreBlockBlock extends NatureandmythsModElements.ModElement {
	@ObjectHolder("natureandmyths:alejandrite_ore_block")
	public static final Block block = null;
	public AlejandriteOreBlockBlock(NatureandmythsModElements instance) {
		super(instance, 161);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("alejandrite_ore_block");
		}
