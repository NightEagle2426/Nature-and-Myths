...
public class BlockMercuryore extends ElementsNatureandMyths.ModElement {
	@GameRegistry.ObjectHolder("natureandmyths:mercuryore")
	public static final Block block = null;
	public BlockMercuryore(ElementsNatureandMyths instance) {
		super(instance, 532);
	}
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0,
				new ModelResourceLocation("natureandmyths:mercuryore", "inventory"));
	}
