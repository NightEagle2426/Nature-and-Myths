...
public class Cactusmx1Block extends NatureandmythsModElements.ModElement {
	@ObjectHolder("natureandmyths:cactusmx_1")
	public static final Block block = null;
	public Cactusmx1Block(NatureandmythsModElements instance) {
		super(instance, 963);
	}
	...
	public void init(FMLCommonSetupEvent event) {
		...
		for (Biome biome : ForgeRegistries.BIOMES.getValues()) {
			...
			if (ForgeRegistries.BIOMES.getKey(biome).equals(new ResourceLocation("natureandmyths:mexican_desert")))
				biomeCriteria = true;
			if (!biomeCriteria)
				continue;
	...
	public static class BlockCustomFlower extends FlowerBlock {
		public BlockCustomFlower() {
			super(Effects.SATURATION, 0, Block.Properties.create(Material.PLANTS).doesNotBlockMovement().sound(SoundType.CROP)
					.hardnessAndResistance(1f, 1f).lightValue(0));
			setRegistryName("cactusmx_1");
		}
